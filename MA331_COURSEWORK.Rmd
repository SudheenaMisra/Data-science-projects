...
When look at the structure of the data I found that the child dataset consist of 3380 rows and 2 columns and adult dataset consist 20024 rows and 2 columns.The names of the variables(coulmns) of both datasets(child and adult) is found to be "gutenberg_id" and "text".
